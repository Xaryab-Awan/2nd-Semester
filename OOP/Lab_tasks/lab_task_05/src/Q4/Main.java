...
public class Main {
    public static void main(String[] args) {
        ...
        Course course2 = new Course("MVC I", "MATH101");
        Course course3 = new Course("Aplied Physics", "PHY101");
        ...
        Student student3 = new Student("S003", "abdullah", "Computer Science");
        Student student4 = new Student("S004", "uzair", "Physics");
        Student student5 = new Student("S005", "arham", "Computer Science");
